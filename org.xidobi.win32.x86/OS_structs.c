...
void cacheDCBFields(JNIEnv *env, jobject dcbObject) {
	...
	DCBc.fAbortOnError = (*env)->GetFieldID(env, DCBc.clazz, "fAbortOnError",
			"I");
	DCBc.fBinary = (*env)->GetFieldID(env, DCBc.clazz, "fBinary", "I");
	DCBc.fDsrSensitivity = (*env)->GetFieldID(env, DCBc.clazz,
			"fDsrSensitivity", "I");
	...
	DCBc.fOutxCtsFlow = (*env)->GetFieldID(env, DCBc.clazz, "fOutxCtsFlow",
			"I");
	DCBc.fOutxDsrFlow = (*env)->GetFieldID(env, DCBc.clazz, "fOutxDsrFlow",
			"I");
	DCBc.fParity = (*env)->GetFieldID(env, DCBc.clazz, "fParity", "I");
	DCBc.fRtsControl = (*env)->GetFieldID(env, DCBc.clazz, "fRtsControl", "I");
	DCBc.fTXContinueOnXoff = (*env)->GetFieldID(env, DCBc.clazz,
			"fTXContinueOnXoff", "I");
...
DCB *getDCBFields(JNIEnv *env, jobject dcbObject, DCB *dcbStruct) {
	...
	dcbStruct->fAbortOnError = (*env)->GetIntField(env, dcbObject,
			DCBc.fAbortOnError);
	dcbStruct->fBinary = (*env)->GetIntField(env, dcbObject, DCBc.fBinary);
	dcbStruct->fDsrSensitivity = (*env)->GetIntField(env, dcbObject,
			DCBc.fDsrSensitivity);
	dcbStruct->fDtrControl = (*env)->GetIntField(env, dcbObject,
			DCBc.fDtrControl);
	dcbStruct->fDummy2 = (*env)->GetIntField(env, dcbObject, DCBc.fDummy2);
	dcbStruct->fErrorChar = (*env)->GetIntField(env, dcbObject,
			DCBc.fErrorChar);
	...
	dcbStruct->fOutxCtsFlow = (*env)->GetIntField(env, dcbObject,
			DCBc.fOutxCtsFlow);
	dcbStruct->fOutxDsrFlow = (*env)->GetIntField(env, dcbObject,
			DCBc.fOutxDsrFlow);
	dcbStruct->fParity = (*env)->GetIntField(env, dcbObject, DCBc.fParity);
	dcbStruct->fRtsControl = (*env)->GetIntField(env, dcbObject,
			DCBc.fRtsControl);
	dcbStruct->fTXContinueOnXoff = (*env)->GetIntField(env, dcbObject,
			DCBc.fTXContinueOnXoff);
	dcbStruct->wReserved = (*env)->GetShortField(env, dcbObject,
			DCBc.wReserved);
	dcbStruct->wReserved1 = (*env)->GetShortField(env, dcbObject,
			DCBc.wReserved1);
...
void setDCBFields(JNIEnv *env, jobject dcbObject, DCB *dcbStruct) {
	...
	(*env)->SetIntField(env, dcbObject, DCBc.BaudRate,
			(jint) dcbStruct->BaudRate);
	(*env)->SetByteField(env, dcbObject, DCBc.ByteSize,
			(jbyte) dcbStruct->ByteSize);
	(*env)->SetIntField(env, dcbObject, DCBc.DCBlength,
			(jint) dcbStruct->DCBlength);
	(*env)->SetCharField(env, dcbObject, DCBc.EofChar,
			(jchar) dcbStruct->EofChar);
	(*env)->SetCharField(env, dcbObject, DCBc.ErrorChar,
			(jchar) dcbStruct->ErrorChar);
	(*env)->SetCharField(env, dcbObject, DCBc.EvtChar,
			(jchar) dcbStruct->EvtChar);
	(*env)->SetByteField(env, dcbObject, DCBc.Parity,
			(jbyte) dcbStruct->Parity);
	(*env)->SetByteField(env, dcbObject, DCBc.StopBits,
			(jbyte) dcbStruct->StopBits);
	(*env)->SetCharField(env, dcbObject, DCBc.XoffChar,
			(jchar) dcbStruct->XoffChar);
	(*env)->SetShortField(env, dcbObject, DCBc.XoffLim,
			(jshort) dcbStruct->XoffLim);
	(*env)->SetCharField(env, dcbObject, DCBc.XonChar,
			(jchar) dcbStruct->XonChar);
	(*env)->SetShortField(env, dcbObject, DCBc.XonLim,
			(jshort) dcbStruct->XonLim);
	(*env)->SetIntField(env, dcbObject, DCBc.fAbortOnError,
			(jint) dcbStruct->fAbortOnError);
	(*env)->SetIntField(env, dcbObject, DCBc.fBinary,
			(jint) dcbStruct->fBinary);
	(*env)->SetIntField(env, dcbObject, DCBc.fDsrSensitivity,
			(jint) dcbStruct->fDsrSensitivity);
	(*env)->SetIntField(env, dcbObject, DCBc.fDtrControl,
			(jint) dcbStruct->fDtrControl);
	(*env)->SetIntField(env, dcbObject, DCBc.fDummy2,
			(jint) dcbStruct->fDummy2);
	(*env)->SetIntField(env, dcbObject, DCBc.fErrorChar,
			(jint) dcbStruct->fErrorChar);
	...
	(*env)->SetIntField(env, dcbObject, DCBc.fOutxCtsFlow,
			(jint) dcbStruct->fOutxCtsFlow);
	(*env)->SetIntField(env, dcbObject, DCBc.fOutxDsrFlow,
			(jint) dcbStruct->fOutxDsrFlow);
	(*env)->SetIntField(env, dcbObject, DCBc.fParity,
			(jint) dcbStruct->fParity);
	(*env)->SetIntField(env, dcbObject, DCBc.fRtsControl,
			(jint) dcbStruct->fRtsControl);
	(*env)->SetIntField(env, dcbObject, DCBc.fTXContinueOnXoff,
			(jint) dcbStruct->fTXContinueOnXoff);
	(*env)->SetShortField(env, dcbObject, DCBc.wReserved,
			(jshort) dcbStruct->wReserved);
	(*env)->SetShortField(env, dcbObject, DCBc.wReserved1,
			(jshort) dcbStruct->wReserved1);
}
...
void cacheNativeByteArrayFields(JNIEnv *env, jobject nativeByteArray) {
	...
	NativeByteArrayc.cPointer = (*env)->GetFieldID(env, NativeByteArrayc.clazz,
			"cPointer", "I");
...
jbyte *getNativeByteArray(JNIEnv *env, jobject nativeByteArray) {
	...
	jbyte *bytes = (jbyte *) (*env)->GetIntField(env, nativeByteArray,
			NativeByteArrayc.cPointer);
...
/*
 * a struct to cache the DWORD fields
 */
typedef struct DWORD_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID cPointer;
} DWORD_FID_CACHE;
// cache for DWORD fields
DWORD_FID_CACHE DWORDc;

/*
 * Caches the DWORD fields in the DWORD_FID_CACHE.
 */
void cacheDWORDFields(JNIEnv *env, jobject dword) {
	if (DWORDc.cached)
		return;

	DWORDc.clazz = (*env)->GetObjectClass(env, dword);

	DWORDc.cPointer = (*env)->GetFieldID(env, DWORDc.clazz, "cPointer", "I");
 ...
 * Retrieves the fields from the given jobject and returns it as DWORD*.
 */
DWORD *getDWORD(JNIEnv *env, jobject dword) {
	if (!DWORDc.cached)
		cacheDWORDFields(env, dword);

	DWORD *ptr = (DWORD *) (*env)->GetIntField(env, dword, DWORDc.cPointer);
