/*
 * This class was written by Réal Gagnon and is released under the creative 
 * commons license 'Attribution-NonCommercial-ShareAlike 2.5 Canada'. The
 * source can be found under http://www.rgagnon.com/javadetails/java-0630.html. 
 */
...
public class WinRegistry {
	...
	private static List<String> readStringSubKeys(Preferences root, int hkey, String key) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		...
		int count = info[0]; // Fix: info[2] was being used here with wrong results. Suggested by
								// davenpcj, confirmed by Petrucio
		int maxlen = info[3]; // value length max
		for (int index = 0; index < count; index++) {
